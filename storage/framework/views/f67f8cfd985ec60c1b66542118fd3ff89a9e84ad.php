...
<title>Student Paper Coding</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-11">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form  action="<?php echo e(url('/testing_spc')); ?>" enctype = "multipart/form-data" method="POST">
                            <?php echo e(csrf_field()); ?>
                               ...
                               <div class="form-group row">
                                ...
                                <div class="form-group row">
 								...
 								<div class="form-group row">
                                    <label class="col-md-3 col-form-label text-md-right">Paper Coding</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.form_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sr7/Desktop/my_blog2/resources/views/test/spc.blade.php ENDPATH**/ ?>