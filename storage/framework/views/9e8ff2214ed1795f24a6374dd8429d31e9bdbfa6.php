        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form  action="<?php echo e(url('/teacher_registration')); ?>" enctype = "multipart/form-data" method="POST">
...
<?php echo $__env->make('master.form_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sr7/Desktop/my_blog2/resources/views/marks/course.blade.php ENDPATH**/ ?>